...
#define STACK_MAX_GROWTH (8 * 1024 * 1024)
static void lazy_loading (struct supplemental_page *);
static bool should_grow_stack (void *, void *, bool);
...
page_fault (struct intr_frame *f) 
{
  ...
  struct supplemental_page *upage_to_load = find_page (fault_upage, cur);
...
/* Determine whehter or not the stack should grow. */
static bool
